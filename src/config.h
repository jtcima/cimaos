...
#define CIMAOS_USER_PROGRAM_STACK_SZIE 1024 * 16
#define CIMAOS_PROGRAM_VIRTUAL_STACK_ADDRESS_START 0x3FF000
#define CIMAOS_PROGRAM_VIRTUAL_STACK_ADDRESS_END CIMAOS_PROGRAM_VIRTUAL_STACK_ADDRESS_START - CIMAOS_USER_PROGRAM_VIRTUAL_ADDRESS
